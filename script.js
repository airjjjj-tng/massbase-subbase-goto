...
function renderFAQ(filter) {
    ...
    filtered.forEach(item => {
        ...
        div.innerHTML = `
            ...
            <div class="faq-answer"><div class="faq-answer-inner" style="padding-top:16px; line-height: 1.8;">${item.a}</div></div>
        `;
...
// Initial render (No "all" tab, default to first tab)
...
function calculatePrice() {
    ...
    let days = parseInt(simDays.value) || 30;
